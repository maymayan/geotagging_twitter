...
# read the test data to DataFrame using pandas
...
# the predictions on given test data are being written to "predictions.txt" file
predictions = loaded_model.predict(X)
print('\n'.join(map(str, predictions)),file='predictions.txt')
